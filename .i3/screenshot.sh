...
if [ "$1" = "full" ]
  ...
  then
  scrot -u 'screenshot_%F_%T_$wx$h.png' -e 'mv $f ~/Screenshots/ & twmnc -t "Printscreen" -c "Saved window screenshot." & exec scp /home/kacper/Screenshots/$f www@kocproz.ovh:/home/www/static.kocproz.ovh/ & echo "http://static.kocproz.ovh/$f" | xsel --clipboard'
else
